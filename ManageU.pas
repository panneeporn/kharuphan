...
type
  TMange = class(TForm)
    ...
    MyQuery2vn: TStringField;
    MyQuery2fullname: TStringField;
    MyQuery2hn: TStringField;
    MyQuery2cid: TStringField;
    MyQuery2vstdate: TDateField;
    MyQuery2pttype: TStringField;
    MyQuery2name: TStringField;
    MyQuery2main_dep: TStringField;
    MyQuery2department: TStringField;
    MyQuery2ECLAIM_NO: TStringField;
    MyQuery2HN_1: TStringField;
    MyQuery2AN: TStringField;
    MyQuery2DATEADM: TStringField;
    MyQuery2hospmain: TStringField;
    MyQuery2main_name: TStringField;
    MyQuery2hospsub: TStringField;
    MyQuery2sub_name: TStringField;
    MyQuery2pdx: TStringField;
    MyQuery2dx_doctor: TStringField;
    MyQuery2income: TStringField;
    MyQuery2paid_money: TStringField;
    MyQuery2remain_money: TStringField;
    MyQuery2uc_money: TStringField;
    MyQuery2item_money: TStringField;
    MyQuery2flag: TStringField;
    MyQuery2hide: TStringField;
    MyQuery2comment: TStringField;
    MyQuery2state: TStringField;
    MyQuery2con_time: TDateTimeField;
    cxGrid1DBTableView1con_time: TcxGridDBColumn;
    MyQuery4id: TIntegerField;
    MyQuery4vn: TStringField;
    MyQuery4fullname: TStringField;
    MyQuery4hn: TStringField;
    MyQuery4cid: TStringField;
    MyQuery4vstdate: TDateField;
    MyQuery4pttype: TStringField;
    MyQuery4name: TStringField;
    MyQuery4main_dep: TStringField;
    MyQuery4department: TStringField;
    MyQuery4ECLAIM_NO: TStringField;
    MyQuery4HN_1: TStringField;
    MyQuery4AN: TStringField;
    MyQuery4DATEADM: TStringField;
    MyQuery4hospmain: TStringField;
    MyQuery4main_name: TStringField;
    MyQuery4hospsub: TStringField;
    MyQuery4sub_name: TStringField;
    MyQuery4pdx: TStringField;
    MyQuery4dx_doctor: TStringField;
    MyQuery4income: TStringField;
    MyQuery4paid_money: TStringField;
    MyQuery4remain_money: TStringField;
    MyQuery4uc_money: TStringField;
    MyQuery4item_money: TStringField;
    MyQuery4flag: TStringField;
    MyQuery4hide: TStringField;
    MyQuery4comment: TStringField;
    MyQuery4state: TStringField;
    MyQuery4regdate: TDateField;
    MyQuery4dchdate: TDateField;
    MyQuery4con_time: TDateTimeField;
...
uses MainU, datamodual, Manage_StatusU, FilenameU;
...
procedure TMange.cxButton4Click(Sender: TObject);
begin
if IsFormOpen('Filename') = False  then
     Application.CreateForm(TFilename,Filename);
     Filename.Show;
end;
...
procedure TMange.cxGrid2DBTableView1CellDblClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin

      label1.Caption := 'IPD';
       if cxDBLabel4.Caption = '0' then
        begin
            if IsFormOpen('Mange_Status') = False  then
                Application.CreateForm(TMange_Status,Mange_Status);
                 Mange_Status.ShowModal;
