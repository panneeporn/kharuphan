...
begin
  if cxTextEdit1.Text = cxTextEdit2.Text then
     begin
         ...
         ShowMessage('เปลี่ยนข้อมูล Password เรียบร้อยแล้ว');

     end
  else
     ShowMessage('ตรวจสอบรหัสผ่านทั้งสองช่อง');
...
MyQuery1.Open;
cxTextEdit1.Text := MyQuery1.FieldByName('u_pass').AsString;
cxTextEdit2.Text := MyQuery1.FieldByName('u_pass').AsString;
end;
