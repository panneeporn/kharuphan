...
if MyQuery2.Locate('sum_an',VarArrayOf([edit1.text]),[]) then
          ...
          if (pamacy_acc = 'Y') and (pamacy_send = 'N') then
           ...
           if (pamacy_acc = 'Y') and (pamacy_send = 'Y') and (doctor_acc = 'Y') and (doctor_send = 'N')  then
            ...
            if (pamacy_acc = 'Y') and (pamacy_send = 'Y') and (doctor_acc = 'Y') and (doctor_send = 'Y') and (mrs_acc = 'Y') and (mrs_send = 'Y') and (pragun_acc = 'Y') and (pragun_send = 'N')  then
              begin
                 ShowMessage('เวชระเบียนดังกล่าวอยู่ในความครอบครองของงานประกัน');
              end;
            if (pamacy_acc = 'Y') and (pamacy_send = 'Y') and (doctor_acc = 'Y') and (doctor_send = 'Y') and (mrs_acc = 'Y') and (mrs_send = 'Y') and (pragun_acc = 'Y') and (pragun_send = 'Y') and (card_acc = 'N')   then
              begin
                ShowMessage('เวชระเบียนดังกล่าวอยู่ระหว่างการรอรับการลงทะเบียนของห้องบัตร');
              end;
            if (pamacy_acc = 'Y') and (pamacy_send = 'Y') and (doctor_acc = 'Y') and (doctor_send = 'Y') and (mrs_acc = 'Y') and (mrs_send = 'Y') and (pragun_acc = 'Y') and (pragun_send = 'Y') and (card_acc = 'Y') and (card_send = 'N')   then
              begin
                ShowMessage('เวชระเบียนดังกล่าวอยู่ในความครอบครองของห้องบัตร');
              end;
            if (pamacy_acc = 'Y') and (pamacy_send = 'Y') and (doctor_acc = 'Y') and (doctor_send = 'Y') and (mrs_acc = 'Y') and (mrs_send = 'Y') and (pragun_acc = 'Y') and (pragun_send = 'Y') and (card_acc = 'Y') and (card_send = 'Y')   then
              begin
                ShowMessage('สิ้นสุดกระบวนการเวชระเบียนดังกล่าวอยู่ในความรับผิดชอบของห้องบัตร');
              end;
  ...
  begin
    ShowMessage('AN ที่คุณเลือกไม่อยู่ในระบบ');
  end;
...
begin
     ...
     begin
       ...
       if strtoint(Ilabel1) > 2 then
            begin
                ...
                ShowMessage('การส่งต่อ Chart ผู้ป่วยรายนี้ล่าช้า โดยมีระยะเวลาเกินกำหนด '+datepama);
                MyQuery5.Open;
                MyQuery5.Append;
                ...
                MyQuery5.FieldByName('dep').AsString := 'ห้องยารับช้าเกิน 2 วัน';
      ...
      begin
       ...
       if strtoint(Ilabel1) > 3 then
            begin
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'ห้องยาอยู่ในกระบวนการนานเกิน 3 วัน';
 ...
 if RadioGroup1.Buttons[2].Checked = true then
      begin
          ShowMessage('เวชระเบียนดังกล่าวออกจากระบบเรียบร้อยแล้ว');
      end;
     ...
     ////////// เช็ควันคงเหลือ////////
       ...
       if strtoint(Ilabel1) > 7 then
            begin
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'แพทย์กดรับช้าเกิน 2 วัน';
      ...
      begin
       ...
       if strtoint(Ilabel1) > 10 then
            begin
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'แพทย์อยู่่ในกระบวนการนานเกิน 10 วัน';
     ...
     ////////// เช็ควันคงเหลือ////////
       ...
       if strtoint(Ilabel1) > 19 then
            begin
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'เวชสถิติรับช้าเกิน 2 วัน';
      ...
      if strtoint(Ilabel1) > 3 then
            begin
               ...
               MyQuery5.Append;
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'เวชสถิติอยู่ในกระบวนการนานเกิน 3 วัน';
     ...
     ////////// เช็ควันคงเหลือ////////
       ...
       if strtoint(Ilabel1) > 23 then
            begin
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'งานประกันรับช้าเกิน 1 วัน';
...
//////////////ตรวจสอบเงื่อนไขเพื่อเช็คจำนวนวันและความทันเวลา//////
        MyQuery4.Close;
...
////////////// Query เพื่อหาว่าส่งทันเวลาหรือไม่///////////
       MyQuery4.Close;
...
//////////////////ตรวจสอบว่าระยะเวลาอยู่งานประกันเกิน 3 วันหรือไม่////////
       if strtoint(Ilabel1) > 3 then
            begin
                datepama :=  inttostr(strtoint(Ilabel1) - 3);
                ShowMessage('การส่งต่อ Chart ผู้ป่วยรายนี้ล่าช้า โดยมีระยะเวลาเกินกำหนด '+datepama);
                ...
                MyQuery5.FieldByName('dateacc').AsDateTime := dateacc;
                MyQuery5.FieldByName('datesend').AsDateTime := datesend;
                MyQuery5.FieldByName('dep').AsString := 'งานประกันอยู่ในกระบวนการนานเกิน 3 วัน';
...
begin
  if RadioGroup1.Buttons[0].Checked = true then
     begin
      ShowMessage('เวชระเบียนดังกล่าวยังไม่อยู่ในแผนกไม่สามารถลบได้');
     end ;
  if RadioGroup1.Buttons[1].Checked = true then
      begin
       MyQuery1.Open;
