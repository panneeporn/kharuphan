...
type
  TForm6 = class(TForm)
    ...
    Query1สถานพยาบาลหลก: TStringField;
    Query1hospsub: TStringField;
    Query1สถานพยาบาลรอง: TStringField;
    ...
    Query2สถานพยาบาลหลก: TStringField;
    Query2hospsub: TStringField;
    Query2สถานพยาบาลรอง: TStringField;
      ...
      begin
        ...
        while not  Query1.Eof do
          begin
                          ...
                          main_name := Query1.FieldByName('สถานพยาบาลหลัก').AsString;
                          hospsub := Query1.FieldByName('hospsub').AsString;
                          sub_name := Query1.FieldByName('สถานพยาบาลรอง').AsString;
          ...
          if Query1.Eof then
             begin
               ShowMessage('บันทึกลงฐานข้อมูลเรียบร้อยแล้ว Filename = '+'OPD-'+inttostr(countopd)+'-'+Time1);
             end;
      ...
      begin
        ...
        while not  Query2.Eof do
          begin
                ...
                main_name_ipd := Query2.FieldByName('สถานพยาบาลหลัก').AsString;
                ...
                dx_doctor_ipd := Query2.FieldByName('dx_doctor').AsString;
                 ...
                 hospsub_ipd := Query2.FieldByName('hospsub').AsString;
                  sub_name_ipd := Query2.FieldByName('สถานพยาบาลรอง').AsString;
         ...
         if Query2.Eof then
             begin
               ShowMessage('บันทึกลงฐานข้อมูลเรียบร้อยแล้ว Filename = '+'IPD-'+inttostr(countipd)+'-'+Time2);
             end;
