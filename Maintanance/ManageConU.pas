...
uses
  ...
  cxButtons, cxContainer, cxLabel, cxDBLabel;
...
type
  TManage_Con = class(TForm)
    ...
    IPDid: TIntegerField;
    IPDvn: TStringField;
    IPDfullname: TStringField;
    IPDhn: TStringField;
    IPDcid: TStringField;
    IPDvstdate: TDateField;
    IPDpttype: TStringField;
    IPDname: TStringField;
    IPDmain_dep: TStringField;
    IPDdepartment: TStringField;
    IPDECLAIM_NO: TStringField;
    IPDHN_1: TStringField;
    IPDAN: TStringField;
    IPDDATEADM: TStringField;
    IPDhospmain: TStringField;
    IPDmain_name: TStringField;
    IPDhospsub: TStringField;
    IPDsub_name: TStringField;
    IPDpdx: TStringField;
    IPDdx_doctor: TStringField;
    IPDincome: TStringField;
    IPDpaid_money: TStringField;
    IPDremain_money: TStringField;
    IPDuc_money: TStringField;
    IPDitem_money: TStringField;
    IPDflag: TStringField;
    IPDhide: TStringField;
    IPDcomment: TStringField;
    IPDstate: TStringField;
    IPDregdate: TDateField;
    IPDdchdate: TDateField;
    IPDcon_time: TDateTimeField;
    IPDstate2: TStringField;
    IPDcomment2: TStringField;
    IPDcon_time2: TDateTimeField;
    IPDserail_c: TStringField;
...
uses datamodual, MainU, ManageCon_Add_ComU;
...
procedure TManage_Con.cxGrid1DBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
      if IsFormOpen('ManageCon_Add_C') = False  then
     Application.CreateForm(TManageCon_Add_C,ManageCon_Add_C);
     ManageCon_Add_C.ShowModal;
...
procedure TManage_Con.cxGrid2DBTableView1CellDblClick(
  Sender: TcxCustomGridTableView; ACellViewInfo: TcxGridTableDataCellViewInfo;
  AButton: TMouseButton; AShift: TShiftState; var AHandled: Boolean);
begin
if IsFormOpen('ManageCon_Add_C') = False  then
