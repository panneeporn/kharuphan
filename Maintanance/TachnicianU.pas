...
begin
    if Edit2.Text = '0' then
       begin
            if (DBText9.Caption = 'Y') or (DBText9.Caption = 'N') then
                begin
                      ShowMessage('จบกระบวนการแจ้งซ่อม');
                end ;
            ...
            if (DBText9.Caption = 'C') or (DBText9.Caption = 'P') then
                 begin
                        ...
                        if (DBText7.Caption = 'N') then
                            begin
                                ShowMessage('ช่างไม่สามารถซ่อมได้จบกระบวนการ');
                            end;
    ...
    if Edit2.Text = '1' then
       begin
            ShowMessage('ปิดการใช้งานการส่งข้อมูล');
       end;
...
if supplies = '1' then
   begin
       Label6.Caption := 'เจ้าหน้าที่พัสดุ';
       Edit1.Text := '2';
       Showgrid.Close;
       Showgrid.SQL.Text := 'select * from main_t where status_s = '+'"'+'2'+'"';
       Showgrid.Open;
   ...
   if edit1.Text = '1' then
      begin
           if DBText13.caption = '0' then
              ...
              ShowMessage('ข้อมูลส่วนนี้ได้ปิดจ๊อบงานแล้ว');

      end
   else
      ShowMessage('เมนูนี้เฉพาะช่างเทคนิค');
